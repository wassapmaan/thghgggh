toys = {
    ...
    "Пазл": ["1000 элементов", 12.99, 10],
    "Машинка": ["Скоростная машинка", 9.99, 8],
    "Плюшевый мишка": ["Мягкий и пушистый", 14.99, 4]
}
...
def purchase():
    total_price = 0
    while True:
        toy_name = input("Введите название игрушки (или 'FF' для выхода): ")
        if toy_name == 'FF':
            break
