def create_merged_tuple(tuple1, tuple2):
    ...
    if not isinstance(tuple1, tuple) or not isinstance(tuple2, tuple):
        print("Ошибка! Введи кортежи.")
        return None

    merged_tuple = tuple1 + tuple2
    return merged_tuple

input_tuple1 = input("Введи элементы первого кортежа через пробел: ")
tuple1 = tuple(input_tuple1.split())

input_tuple2 = input("Введи элементы второго кортежа через пробел: ")
